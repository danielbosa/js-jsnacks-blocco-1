...
4. Ad ogni ciclata, aggiungo elemento n(i) tramite push all'array vuoto;
...
let numElementi = parseInt(prompt('Quanti elementi vuoi vedere?'));
let arrayVuoto = [];

for (i = 0; i < numElementi; i++){
    arrayVuoto[i] = RndNumberGen(1, 100);
    console.log(arrayVuoto[i]);
    arrayVuoto.push(arrayVuoto[i]);
